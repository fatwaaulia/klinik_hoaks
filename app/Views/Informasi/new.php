                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <div class="w-50 position-relative">
                                        <img src="<?= base_url('assets/img/default.png') ?>" class="<?= $val->hasError('img') ? "border border-danger" : '' ?> w-100 h-100 img-style" id="frame">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= $val->hasError('sumber') ? "is-invalid" : '' ?>" name="sumber" value="<?= old('sumber') ?>" id="sumber" placeholder="Masukkan sumber">
                                    <div class="invalid-feedback">
                                        <?= $val->getError('sumber') ?>
                                    </div>
                                </div>
